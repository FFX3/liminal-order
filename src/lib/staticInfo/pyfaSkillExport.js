// Complete PyFA export containing all EVE Online skills

import { skillIdToName } from "./skillsIdNameMap";

// Paste your full PyFA export here - this serves as the master skill list
const PYFA_EXPORT = `
Abyssal Ore Processing 0
Acceleration Control 0
Accounting 0
Advanced Broker Relations 0
Advanced Capital Ship Construction 0
Advanced Contracting 0
Advanced Doomsday Operation 0
Advanced Drone Avionics 0
Advanced Induction Efficiency 0
...
Assault Frigates 0
Astrogeology 0
Astrometric Acquisition 0
Astrometric Pinpointing 0
Astrometric Rangefinding 0
Astrometrics 0
...
Black Ops 0
Bomb Deployment 0
Breacher Pod Clone Efficacity 0
Breacher Pod Clone Longevity 0
Breacher Pod Launcher Operation 0
Breacher Pod Projection 0
Breacher Pod Rapid Firing 0
Broker Relations 0
...
Caldari Titan 0
Capacitor Emission Systems 0
Capacitor Management 0
Capacitor Systems Operation 0
...
Capital Industrial Reconfiguration 0
Capital Industrial Ships 0
Capital Jump Portal Generation 0
Capital Micro Jump Drive Operation 0
...
Drone Interfacing 0
Drone Navigation 0
Drone Sharpshooting 0
Drones 0
Drones Rigging 0
Drug Manufacturing 0
EDENCOM Battleship 0
EDENCOM Cruiser 0
EDENCOM Frigate 0
...
Electronics Upgrades 0
Elite Infomorph Psychology 0
Empire Control 0
Energy Grid Upgrades 0
Energy Pulse Weapons 0
Energy Weapon Rigging 0
Evasive Maneuvering 0
Exceptional Moon Ore Processing 0
Executive Paragon Partnership 0
Exhumers 0
Expedition Frigates 0
Explosive Armor Compensation 0
Explosive Shield Compensation 0
Fast Talk 0
Fighter Hangar Management 0
Fighters 0
Flag Cruisers 0
Fleet Command 0
Fleet Compression Logistics 0
Fleet Coordination 0
Fleet Formations 0
Frequency Modulation 0
Fuel Conservation 0
Gallente Battlecruiser 0
Gallente Battleship 0
Gallente Carrier 0
Gallente Core Systems 0
Gallente Cruiser 0
Gallente Defensive Systems 0
Gallente Destroyer 0
Gallente Dreadnought 0
Gallente Drone Specialization 0
Gallente Encryption Methods 0
Gallente Freighter 0
Gallente Frigate 0
Gallente Hauler 0
Gallente Offensive Systems 0
Gallente Propulsion Systems 0
Gallente Starship Engineering 0
Gallente Strategic Cruiser 0
Gallente Tactical Destroyer 0
Gallente Titan 0
Gas Cloud Harvesting 0
Gas Decompression Efficiency 0
Gravimetric Sensor Compensation 0
Graviton Physics 0
Guided Missile Precision 0
Gunnery 0
Hacking 0
Heavy Assault Cruisers 0
Heavy Assault Missile Specialization 0
Heavy Assault Missiles 0
Heavy Drone Operation 0
Heavy Fighters 0
Heavy Interdiction Cruisers 0
Heavy Missile Specialization 0
Heavy Missiles 0
High Energy Physics 0
High Speed Maneuvering 0
Hub Algorithm Optimization 0
Hub Promotion 0
Hull Upgrades 0
Hybrid Weapon Rigging 0
Hydromagnetic Physics 0
Ice Harvesting 0
Ice Harvesting Drone Operation 0
Ice Harvesting Drone Specialization 0
Ice Processing 0
Induction Efficiency 0
Industrial Command Ships 0
Industrial Reconfiguration 0
Industrial Sequencing 0
Industry 0
...
Interceptors 0
Interdictors 0
Interplanetary Consolidation 0
Invulnerability Core Operation 0
...
Large Pulse Laser Specialization 0
Large Railgun Specialization 0
Large Vorton Projector 0
Large Vorton Specialization 0
Laser Physics 0
Launcher Rigging 0
Leadership 0
Light Drone Operation 0
Light Fighters 0
Light Missile Specialization 0
Light Missiles 0
Logistics Cruisers 0
Logistics Frigates 0
Long Distance Jamming 0
Long Range Targeting 0
Magnetometric Sensor Compensation 0
Marauders 0
Marketing 0
Mass Production 0
Mass Reactions 0
...
Mechanics 0
Medium Artillery Specialization 0
Medium Autocannon Specialization 0
Medium Beam Laser Specialization 0
Medium Blaster Specialization 0
Medium Disintegrator Specialization 0
Medium Drone Operation 0
Medium Energy Turret 0
Medium Hybrid Turret 0
Medium Precursor Weapon 0
Medium Projectile Turret 0
Medium Pulse Laser Specialization 0
Medium Railgun Specialization 0
Medium Vorton Projector 0
Medium Vorton Specialization 0
Megacorp Management 0
Mercenary Den Management 0
Mercoxit Ore Processing 0
Metallurgy 0
Micro Jump Drive Operation 0
Mining 0
Mining Barge 0
Mining Connections 0
Mining Director 0
Mining Drone Operation 0
Mining Drone Specialization 0
Mining Foreman 0
Mining Frigate 0
Mining Upgrades 0
Minmatar Battlecruiser 0
Minmatar Battleship 0
Minmatar Carrier 0
Minmatar Core Systems 0
Minmatar Cruiser 0
Minmatar Defensive Systems 0
Minmatar Destroyer 0
Minmatar Dreadnought 0
Minmatar Drone Specialization 0
Minmatar Encryption Methods 0
Minmatar Freighter 0
Minmatar Frigate 0
Minmatar Hauler 0
Minmatar Offensive Systems 0
Minmatar Propulsion Systems 0
Minmatar Starship Engineering 0
Minmatar Strategic Cruiser 0
Minmatar Tactical Destroyer 0
Minmatar Titan 0
Missile Bombardment 0
Missile Launcher Operation 0
Missile Projection 0
Molecular Engineering 0
Motion Prediction 0
Multi-thread Sequencing 0
Mutagenic Stabilization 0
Mutated Drone Specialization 0
...
Paragon Partnership 0
Paragon Relations 0
Parallel Sequencing 0
Peak Induction Acceleration 0
Planetology 0
Plasma Physics 0
Power Grid Management 0
...
Propulsion Jamming 0
Propulsion Subsystem Technology 0
Quantum Physics 0
...
Upwell Encryption Methods 0
Upwell Freighter 0
Upwell Hauler 0
Upwell Starship Engineering 0
Variegated Ore Processing 0
Visibility 0
Vorton Arc Extension 0
Vorton Arc Guidance 0
Vorton Power Amplification 0
Vorton Projector Operation 0
Warhead Upgrades 0
Warp Drive Operation 0
Weapon Destabilization 0
Weapon Disruption 0
Weapon Upgrades 0
Wholesale 0
Wing Command 0
...
/**
 * Parses the PyFA export to extract all skill names
 * @param {string} pyfaExport - The complete PyFA skill export
 * @returns {Array<string>} Array of skill names in alphabetical order
 */
function parsePyfaExport(pyfaExport) {
  const lines = pyfaExport.trim().split(/\r?\n/);
  const skillNames = [];
  
  for (const line of lines) {
    // Match pattern: "Skill Name #" where # is a number
...
// Parse the PyFA export to get our master skill list
const ALL_SKILL_NAMES = parsePyfaExport(PYFA_EXPORT);

/**
 * Converts ESI skill data to PyFA format
 * @param {{ skill_id: number, active_skill_level: number }[]} esiSkills - Array of skill objects from ESI with {skill_id, active_skill_level}
 * @returns {string} PyFA formatted skill string
 */
export function convertToPyfaFormat(esiSkills) {
  // Create a map of existing skills from ESI data
  const skillLevelMap = new Map();
  
  for (const skill of esiSkills) {
    const skillName = skillIdToName(skill.skill_id);
    if (skillName) {
      skillLevelMap.set(skillName, skill.active_skill_level);
    }
  }
  
  // Build the complete skill list using all skills from PyFA export
  const lines = [];
  for (const skillName of ALL_SKILL_NAMES) {
    const level = skillLevelMap.get(skillName) ?? 0;
    lines.push(`${skillName} ${level}`);
  }
